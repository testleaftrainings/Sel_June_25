...
6:00 to 6:15 ---> Recap
Set:
1)unordered collection--->order of set depends on the implementation classes.
2)does not allows duplicate values.
3)cannot have get method here.

List num[]={1,3,4,3,5,6}//index of 3---1,5--->4
  set-->{1,3,4,5,6}--->index 5--->3

  Implementation classes of set:
  1)HashSet--->maintains random order
  2)LinkedHashSet---->insertion order
  3)TreesSet---->Ascii order
