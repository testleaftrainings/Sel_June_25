3:00 to 3:45 ---> CoreJavaIntroduction
3.45 to 4:00 ---> Breakout
4:00 to 4:30 ---> DataTypes and Variables
4:30 to 4:50 ---> Breakout
4:50 to 5:00 ---> Break
5:00 to 6:00 ---> Operators & Conditional Statements
6:00 to 6:15 ---> Recap
...
_Naming Convention:_ start with lowerCase
Class:
...
DataTypes:
WholeNumbers:
byte-8 bit DataTypes
int-32bit(1 to 9 digits)
short-16bit(to store 5 digits)
long-64bit(9+1)

decimal values:
float-32bit(upto 6-7)
double-64bit(upto 15 )
